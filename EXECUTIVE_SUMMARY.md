...
- **Frontend**: Streamlit (4-tab interface + settings page)
...
- `POST /api/v1/feed/personalized` - Profile-aware personalized subset feed
- `POST /api/v1/feed/personalized-full` - Full personalized feed with explanations
- `POST /api/v1/feed/comparison-test` - A/B comparison (personalized vs baseline)
- `GET /api/v1/onboarding/questions` - Onboarding questionnaire sets
- `POST /api/v1/users/create` - Create and persist user profile
- `GET /api/v1/users` - List saved profiles
